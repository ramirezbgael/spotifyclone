  ...
  return (
    <div className='fixed h-20 left-0 bottom-0 md:ml-64 w-full md:w-[calc(100%-256px)] bg-black flex items-center justify-between md:justify-center p-4 z-40'>
      ...
      <div className='md:ml-40 h10 flex flex-col items-center'>
        ...
        <div className='flex flex-row items-center text-4xl gap-3 mb-2'>
          <button className='hidden md:block'><FaRandom className='text-lg'/></button>
          
          <button className='hidden md:block mb-1'><BiSkipPrevious/></button>
          ...
          <button className='hidden md:block mb-1'><BiSkipNext/></button>

          <button className='hidden md:block mb-1'><BiRepeat className='text-xl'/></button>
        </div>
        
        <progress value={currentTime} max={duration} className='w-72 h-2' />
