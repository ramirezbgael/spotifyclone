...
const Playbar = () => {
  ...
  return (
    <div className='fixed h-20 left-0 bottom-0 md:ml-64 w-full md:w-[calc(100%-256px)] bg-black flex items-center justify-center p-4 z-40'>
      ...
      <div className='ml-40 h10 flex flex-col items-center'>
        
        <div className='flex flex-row items-center text-4xl gap-3'>
          <button><FaRandom className='text-lg'/></button>
          ...
          <button><BiRepeat className='text-xl'/></button>
        </div>
        <div>
          ------------------------------------------
        </div>
      </div>
      <div className='ml-40 flex flex-row gap-2 items-center text-xl'>
